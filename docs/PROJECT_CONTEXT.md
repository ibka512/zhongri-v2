...
Task 012 已完成，Task 013 的代码实现和本地浏览器断网复测已经完成，GOV-001 已通过 PR #22 合并，Task 018/019 已通过负责人 GitHub Pages 验收，当前进行 Task 020 与 Phase 1 收口。
...
当前任务是 **Task 020：英语音标最小切片**；Task 015（[Issue #23](https://github.com/ibka512/zhongri-v2/issues/23)）已经完成负责人真实 v1 数据手工验收，Task 016/017/018/019 已由负责人在 GitHub Pages 验收。Task 020 只复用 canonical 英语词条展示 IPA，并提供当前页面内的词形/音标辨认练习；不执行迁移激活、不写入 LearningEvent，也不接入英语 TTS、远程音频或 AI。
...
1. 完成 Task 020：复用 canonical 英语词条的 IPA 展示与当前页面辨认练习。
