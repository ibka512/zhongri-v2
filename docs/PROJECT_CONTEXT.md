...
- 创建未授权的首页、词库、五十音、IPA、账号、同步、商业化或社区功能；Task 016 只实现已授权的首次设置入口。
