...
1. 用真实/批准的 fixture 复核设备来源与 Mastery/StudyRecord/WrongBook/RecycleBin/AIConversation/AIQuizHistory/Preference/ReminderSetting/FSRS 字段覆盖，运行持久化 staged 重建验证入口，用固定抽样与失败注入入口补齐 V02/V23/V25 证据，再通过已接入的 V01–V25 activation gate 完成真实激活/回滚验收。
