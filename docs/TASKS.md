...
| Task 016   | Phase 1 首次设置与本地学习者目标                  | 实现完成，待验收   | `81a17a4`  |
| Task 017   | 设置与数据安全页入口                              | 实现完成，待验收   | `cf5d328`  |
...
- **Task 017：设置与数据安全页入口** 已实现，待负责人在 GitHub Pages 验收（见 [ADR-039](./decisions/ADR-039-settings-data-page.md)）。本切片只提供本地设置摘要、旧来源三态提示和安全迁移入口，不新增 Schema、数据库表或数据写入行为。
...
| Task 017 设置与数据 | 实现完成，待验收     | 只读设置摘要、旧版来源三态提示、今日/首次设置/迁移预检入口；不扩展设置 Schema、不执行迁移激活。                                                                                                                                                                                                                                                                                                 |
| Phase 1 后续 Task   | 未排期               | Task 017 完成后再定义内容中心、五十音/TTS 和英语/IPA 切片，最后考虑 Phase 2 AI。                                                                                                                                                                                                                                                                                                                |
