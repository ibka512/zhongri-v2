...
| Task              | 状态   | 说明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ----------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Task 015 迁移转换 | 进行中 | canonical corpus、snapshot contract、只读 source adapter、source-aware staging、确定性 idMap、disposition/quarantine 报告、Legacy Source Reader、显式设备来源接线与分歧报告、Word/Override/Folder/Favorite/Mastery/StudyRecord/GroupProgress/WrongBook/RecycleBin/AIConversation/AIQuizHistory/Preference/ReminderSetting/FSRS isolated payload、inline archives、独立 migrationArchives 存储、只验证 V01–V25 报告、staging orchestration、持久化 staged payload 重建验证、activation gate、V23 固定抽样和 V25 失败注入演练入口已完成；继续真实 fixture 字段复核、V02/V23/V25 证据及真实激活/回滚验收。 |
