...
| Task 020   | 英语音标最小切片                                  | 已实现，待发布/验收         | `877bc19`  |
...
- **Task 020：英语音标最小切片** 已按冻结范围实现，已通过本地全量验证，待远端发布和负责人 Pages 验收（见 [TASK-020](./tasks/TASK-020-english-ipa.md) 和 [ADR-042](./decisions/ADR-042-english-ipa.md)）。本切片只复用 canonical 英语词条展示 IPA 并提供当前页面辨认练习，不接入英语 TTS、远程音频、AI 或掌握持久化。
...
| Task 020 英语音标   | 已实现，待发布/验收  | `/ipa` 复用 canonical 英语词条展示 IPA 并提供词形/音标辨认；不接入英语 TTS、远程音频、AI、账号或同步。                                                                                                                                                                                                                                                                                          |
