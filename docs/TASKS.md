...
| Task 020   | 英语音标最小切片                                  | 已推送，待负责人验收        | `db8322e`  |
...
- **Task 020：英语音标最小切片** 已按冻结范围实现、通过本地全量验证并推送，待负责人 Pages 验收（见 [TASK-020](./tasks/TASK-020-english-ipa.md) 和 [ADR-042](./decisions/ADR-042-english-ipa.md)）。本切片只复用 canonical 英语词条展示 IPA 并提供当前页面辨认练习，不接入英语 TTS、远程音频、AI 或掌握持久化。
...
| Task 020 英语音标   | 已推送，待负责人验收 | `/ipa` 复用 canonical 英语词条展示 IPA 并提供词形/音标辨认；不接入英语 TTS、远程音频、AI、账号或同步。                                                                                                                                                                                                                                                                                          |
