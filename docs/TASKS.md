...
- **Task 015：v1 迁移逐域转换与 canonical 身份层** 正在进行（[Issue #23](https://github.com/ibka512/zhongri-v2/issues/23)）。canonical corpus 已固定并导入 9,828 条；接下来实现 source snapshot、逐域转换和激活回滚，真实 backup fixture 到位前不宣称迁移完成。
...
| Task              | 状态   | 说明                                                                                      |
| ----------------- | ------ | ----------------------------------------------------------------------------------------- |
| Task 015 迁移转换 | 进行中 | canonical corpus 已完成；继续 source snapshot、逐域转换、quarantine、V01–V25 和激活回滚。 |
