...
- **Task 015：v1 迁移逐域转换与 canonical 身份层** 正在进行（[Issue #23](https://github.com/ibka512/zhongri-v2/issues/23)）。当前先实现 canonical corpus 契约和 fail-closed 完整性门禁；完整资产与真实脱敏 fixture 到位前，不激活迁移业务域。
...
| Task              | 状态   | 说明                                                                            |
| ----------------- | ------ | ------------------------------------------------------------------------------- |
| Task 015 迁移转换 | 进行中 | 先完成 canonical corpus 契约、资产门禁、fixture harness，再进入逐域转换与激活。 |
