...
- 真实 backup fixture、设备来源与本轮学习事实字段覆盖复核、AI/回收站/preferences 等剩余域、
...
2. 将 inline `archives` 接入独立 rawArchive/quarantine 存储（含保留周期），并实现 AI、回收站、
   preferences 等剩余域。
