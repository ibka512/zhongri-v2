...
- **Task 020：英语音标最小切片** 正在进行。Task 015（[Issue #23](https://github.com/ibka512/zhongri-v2/issues/23)）已完成负责人真实 v1 数据验收，Task 016/017/018/019 已完成负责人 Pages 验收。
...
- 当前仍不包含用户词库管理、AI、远程真实音频、FSRS 参数训练或旧 FSRS 迁移；Task 019 的基础平假名/TTS 已验收，Task 020 仅提供 canonical 英语词条的 IPA 展示和当前页面辨认练习。
...
- Task 020 验收后进行 Phase 1 双语闭环验收，再进入 AI Gateway。
