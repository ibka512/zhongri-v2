...
- Task 015 已完成 canonical corpus Schema、9,828/5,906/3,922 目标声明、真实资产导入和完整性验证；source snapshot、真实脱敏 backup fixture、逐域 transformer 和激活回滚仍未完成。
...
- 接入已固定的 canonical source manifest 与 SHA-256 清单，补齐脱敏 v5+/v10、legacy v4 fixture；在缺少输入时保持 fail-closed。
