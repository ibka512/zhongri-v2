...
- **Task 018：内容中心首个只读切片** 正在进行。Task 015（[Issue #23](https://github.com/ibka512/zhongri-v2/issues/23)）已完成负责人真实 v1 数据验收，Task 016/017 已完成负责人 Pages 验收。
...
- 当前仍不包含用户词库管理、五十音、IPA、TTS、AI、真实音频、FSRS 参数训练或旧 FSRS 迁移。
...
- Task 018 完成后再定义五十音/TTS、英语/IPA；Phase 1 双语闭环验收后才进入 AI Gateway。
