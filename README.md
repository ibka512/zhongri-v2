...
当前工作项是 Task 020：英语音标最小切片。Task 015（[Issue #23](https://github.com/ibka512/zhongri-v2/issues/23)）的 canonical corpus、迁移契约和负责人真实 v1 数据验收已完成；Task 016/017/018/019 已在 GitHub Pages 验收，Task 020 已完成本地实现与全量验证，待远端发布和负责人 Pages 验收。GOV-001 已通过 [PR #22](https://github.com/ibka512/zhongri-v2/pull/22) 合并。

尚未实现真实 v1 逐域迁移与激活、AI、FSRS 参数训练或远程真实音频；Task 019 已完成，Task 020 的英语 IPA 展示和辨认练习已实现，尚待远端发布和 Pages 验收。

## 开发状态

**Task 020 - 英语音标最小切片已实现，待远端发布与负责人验收；Task 016/017/018/019 已验收，Phase 1 收口继续进行。**
...
- Task 020：英语音标最小切片，已实现并通过本地全量验证，待发布/验收。
